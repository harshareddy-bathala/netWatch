...
- Only captures traffic visible to the monitoring interface
- Cannot decrypt HTTPS content (just sees encrypted traffic)
- Health score is an estimate, not a guarantee
- Anomaly detection needs ~24 hours of data to be accurate
